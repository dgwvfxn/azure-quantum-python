...
class JobsOperations:
    ...
    @distributed_trace_async
    async def create(self, job_id: str, job: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Create a job.
    ...
    @distributed_trace_async
    async def patch(self, job_id: str, patch_job: Union[List[JSON], IO[bytes]], **kwargs: Any) -> Optional[JSON]:
        # pylint: disable=line-too-long
        """Patch a job.
...
class StorageOperations:
    ...
    @overload
    async def sas_uri(self, blob_details: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Gets a URL with SAS token for a container/blob in the storage account associated with the
        workspace. The SAS URL can be used to upload job input and/or download job output.
    ...
    @distributed_trace_async
    async def sas_uri(self, blob_details: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        """Gets a URL with SAS token for a container/blob in the storage account associated with the
        workspace. The SAS URL can be used to upload job input and/or download job output.
...
class SessionsOperations:
    ...
    @distributed_trace_async
    async def open(self, session_id: str, session: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Open a session.
    ...
    @distributed_trace_async
    async def close(self, session_id: str, **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Close a session.
    ...
    @distributed_trace
    def jobs_list(self, session_id: str, **kwargs: Any) -> AsyncIterable[JSON]:
        # pylint: disable=line-too-long
