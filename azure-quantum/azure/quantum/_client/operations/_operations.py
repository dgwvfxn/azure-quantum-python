...
class JobsOperations:
            ...
            .. code-block:: python
                ...
                item_details = {
                    ...
                    "jobType": "str",  # Optional. The type of job. Known values are: "Unknown",
                      "QuantumComputing", and "Optimization".
                    "metadata": {
    ...
    @overload
    def create(self, job_id: str, job: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Create a job.
    ...
    @distributed_trace
    def create(self, job_id: str, job: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Create a job.

        :param job_id: Id of the job. Required.
        :type job_id: str
        :param job: The complete metadata of the job to submit. Is either a JSON type or a IO[bytes]
         type. Required.
        :type job: JSON or IO[bytes]
    ...
    @distributed_trace
    def patch(self, job_id: str, patch_job: Union[List[JSON], IO[bytes]], **kwargs: Any) -> Optional[JSON]:
        # pylint: disable=line-too-long
        """Patch a job.
        ...
        :type patch_job: list[JSON] or IO[bytes]
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :return: JSON object or None
...
class StorageOperations:
    ...
    @overload
    def sas_uri(self, blob_details: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Gets a URL with SAS token for a container/blob in the storage account associated with the
        workspace. The SAS URL can be used to upload job input and/or download job output.
    ...
    @distributed_trace
    def sas_uri(self, blob_details: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        """Gets a URL with SAS token for a container/blob in the storage account associated with the
        workspace. The SAS URL can be used to upload job input and/or download job output.
        ...
        :type blob_details: JSON or IO[bytes]
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :return: JSON object
...
class SessionsOperations:
    ...
    @overload
    def open(self, session_id: str, session: JSON, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Open a session.
    ...
    @distributed_trace
    def open(self, session_id: str, session: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Open a session.

        :param session_id: Id of the session. Required.
        :type session_id: str
        :param session: The complete metadata of the session to be opened. Is either a JSON type or a
         IO[bytes] type. Required.
        :type session: JSON or IO[bytes]
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :return: JSON object
    ...
    @distributed_trace
    def close(self, session_id: str, **kwargs: Any) -> JSON:
        # pylint: disable=line-too-long
        """Close a session.
    ...
    @distributed_trace
    def jobs_list(self, session_id: str, **kwargs: Any) -> Iterable[JSON]:
        # pylint: disable=line-too-long
